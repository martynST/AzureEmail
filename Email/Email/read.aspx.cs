...
namespace Email
{
    public partial class read1 : System.Web.UI.Page
    {
        ...
        public static string CheckNewEmail(String username)
        {
            ...
            cmd.CommandText = $"SELECT TOP 1 * FROM emails WHERE reciver = '{username}' AND deleted = 'N' AND status ='R' ORDER BY emailId DESC";
